...
*   **\`step_03-repositories\`**: Implements the **Repository Pattern**. Abstracts data access behind a generic \`IRepository\` interface to decouple business logic from the `EntityManager`.
...
echo "README.md updated with branch descriptions."