...
public class App {
    ...
    public void addItem() {
        ...
        while (choice != 99) {
            ...
            System.out.println("7. Add Foundation");
            System.out.println("8. Add Lipstick");
            ...
            switch(choice) {
                ...
                case 7: item = new Foundation(); break;
                case 8: item = new Lipstick(); break;
    ...
    public void listAny() {
        ...
        while (choice != 99) {
            ...
            switch(choice) {
                ...
                case 7: filter = MakeupProduct.class;break;
                default: System.out.println("Invalid selection."); continue;
            }
